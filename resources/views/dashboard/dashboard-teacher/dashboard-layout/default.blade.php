                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                src="{{ asset($teacher_info->avt)}}" alt="user" class="profile-pic"/></a>
                        <div class="dropdown-menu dropdown-menu-right scale-up">
                            <ul class="dropdown-user">
                                <li>
                                    <div class="dw-user-box">
                                        <div class="u-img"><img src="{{ asset($teacher_info->avt)}}" alt="user"></div>
                                        <div class="u-text">
                                            <h4>{{$user->name}}</h4>
                                            <p>{{$user->email}}</p>
                                        </div>
                                ...
                                <li><a href="{{url('/sms_teacher')}}"><i class="ti-user"></i> Hồ sơ </a></li>
                                <li role="separator" class="divider"></li>
    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            ...
            <div class="user-profile" style="background: url('{{asset('img/logo/logo-background.jpg')}}')  no-repeat;">
                <!-- User profile image -->
                <div class="profile-img"><img src="{{ asset($teacher_info->avt)}}" alt="user"/></div>
                <!-- User profile text-->
                <div class="profile-text"><a class="user-name">{{$teacher_info->name}}</a></div>
            </div>
                ...
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('sms_teacher/editProfile')}}">Thông tin cá nhân </a></li>
                            <li><a href="{{url('sms_teacher/editPassword')}}">Đổi mật khẩu </a></li>
                        </ul>
                    </li>
