            ...
            <div class="card-body">
                <form class="form-horizontal form-material" action="editProfile" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="{{$teacher_info->sdt}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="{{$teacher_info->dia_chi}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="{{$teacher_info->que_quan}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="{{$teacher_info->dan_toc}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="{{$teacher_info->ton_giao}}"
