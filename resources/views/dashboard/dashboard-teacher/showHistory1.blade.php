            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        @if ($day == 8)
                            <h3>Chủ Nhật - {{$date1}} </h3>
                        @else
                            <h3>Thứ {{$day}} - {{$date1}} </h3>
                        @endif
                        <br>
                        @if ($a==1)
                            <h3>Tiết học chưa diễn ra!</h3>
                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3 b-r">
                                        ...
                                        <input type="text" readonly class="form-control-plaintext" id="classs"
                                               name="classs">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row">
                                    <div class="col-md">
                                        ...
                                        <textarea class="form-control" id="review" name="review" required="" rows="5"></textarea>
                                    </div>
                                </div>
                                <hr>
                            </div>
