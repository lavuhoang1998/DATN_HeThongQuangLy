            ...
            <div class="card-body">
                <form class="form-horizontal form-material"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="{{$student_info1->MSHS}} "
                                   class="form-control form-control-line" name="MSHS">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Họ và tên</label>
                        <div class="col-md-12">
                            <input type="text" class="form-control form-control-line" value="{{$student_info->name}}"
                                   name="name">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="email" class="form-control form-control-line" value="{{$student_info->email}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control form-control-line"
                                   value="{{$student_info->password}}" name="password">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Ảnh đại diện (img/avt/student/MSHS.jpg)</label>
                        <div class="col-md-12">
                            <input type="text" value="{{$student_info1->avt}}"
