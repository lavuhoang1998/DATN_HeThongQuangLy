            ...
            <div class="card-body">
                <form class="form-horizontal form-material" action="editPassword" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="password" value="password" class="form-control form-control-line" required="" name="new_password">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Nhập lại mật khẩu</label>
                        <div class="col-md-12">
                            <input type="password" value="password" class="form-control form-control-line" required="" name="new_password1">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
